		...
		<div id="header">
			...
			<div id="wrapper">
				...
				<div id="sidebar">
					<ul>
						<li><h3>
								<a href="/" class="house">P&aacute;gina Principal</a>
							</h3></li>
						<li><h3>
								<a href="/upload?galeria=obraNueva" class="folder_table">Obra
									Nueva</a>
							</h3></li>
						<li><h3>
								<a href="/upload?galeria=reformas" class="manage">Reformas</a>
							</h3></li>
						<li><h3>
								<a href="/upload?galeria=decoracion" class="user">Decoraci&oacute;n</a>
							</h3></li>
						<li><h3>
								<a href="/upload?galeria=oficinas" class="user">Oficinas</a>
							</h3></li>
					</ul>
				</div>
			</div>
			<div id="content">
				<div id="box">
					<h3>Fotos Principal</h3>
					<table width="100%">
						<thead>
							<tr>
								<th width="40px"><a href="#">ID<img
										src="img/icons/arrow_down_mini.gif" width="16" height="16"
				...
				<div id="box">
					...
					<form id="form" action="<%=uploadURL%>" method="POST"
						...
						<fieldset id="personal">
							...
							<input type="file" name="file"> <br /> <input type="hidden" name="op" value="principal" />
						</fieldset>
