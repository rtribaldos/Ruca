...
<%
  ...
  List<MediaObject> fotos = GaleriaDAO.getFotosOrdenadas(galeria, true);
  int contador=0;
%>
...
<body id="page1">
	<div class="container_12">
		...
		<div class="wrapper">
					<div id="content">
						<div class="grid_12b">
							<p><h5><b>PROYECTOS > REFORMAS</b></h5></p> <BR>
							<%
							if(galeria != null){								
								for(MediaObject foto: fotos){
									if(foto.isPrincipal()){
										String urlName="/?galeria=reformas&nombre=" + foto.getTitle()+"&desc="+foto.getDescription() ;
										contador++; 
							%>
									<div class="photoDiv">
